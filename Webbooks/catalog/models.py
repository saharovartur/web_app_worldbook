...
#модель для определния жанров книг
...
#модель для опредления языка книги
...
#модель для определния автора книги(фамилия имя дата рождения и смерти)
...
# общая модель для Книг, использованы связи с другими моделями с помощью первичного значения
# (ForeignKey ManyToManyField)
class Book(models.Model):
    title = models.CharField(max_length=200,
                             help_text="Введите название книги",
                             verbose_name="Название книг")
    ...
    def get_absolute_url(self):
        #Возвращает URL-адрес для доступа к определенному экземпляру
        #должно создать гиперссылку и открывашку на подробную инфу о книге
